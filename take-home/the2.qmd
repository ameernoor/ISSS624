...
### Geospatial
the following panel will show how each geospatial dataset is imported, modify the CRS Code to 3414 to standardize, check on the data and display how the data looks like in Singapore map
