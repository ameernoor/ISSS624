...
First, activate the interactive mode of tmap:

```{r echo=TRUE, eval=TRUE}
tmap_mode("view")
```

Next, the following code will generate an interactive point symbol map:
...
Now you'll have an interactive map displaying condominium resale prices in different areas of Singapore.
