...
tm_shape(flowline) +
  ...
  tm_layout(title = "Weekday Morning Peak Traffic Flow") +
  tm_facets(along = "decile", free.coords = FALSE)

# Save animation as gif
tmap_animation(trips_spread, "../images/trips_spread.gif", loop = TRUE, delay = 500,
               outer.margins = NA, restart.delay=1000)
```
![](../images/trips_spread.gif)
for the first 8th decile, the trips slightly change but still more dense on central.
on the extra category of >5000, north-downtown, west-downtown, north-east, and short trip becomes more visible

# Adding Push & Pull Factors

## Push
show flow vs variables
## Pull
show flow vs variables
