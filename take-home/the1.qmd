...
Utilize `tmap` core functions to construct choropleth maps displaying the Local Moran's I field and p-value field for all four time intervals. Only significant values of Local Moran's I at α 5% are plotted. The following code will fetch the significant Local Moran's I for mapping purpose.
...
## LISA Map at α 5%
To go deeper on the analysis, the following code will fetch the significant LISA for mapping purpose.
...
The choropleth maps above show significant clusters and outliers for passenger trips generated by origin at each hexagon, using α 5%.
...
The spatial distribution reveals higher concentrations of total bus trips in the residential regions of the East, North, and West, in contrast to lower concentrations in the Southern part of Singapore. Notable high-activity clusters are associated with major transportation interchanges such as Ang Mo Kio, Bedok, Clementi, Hougang, Toa Payoh, Woodlands, etc.

### Weekends vs. Weekdays

Certain hexagonal areas, particularly along Bukit Timah and Woodlands Checkpoint, exhibit distinctive patterns during weekends. These areas transition between high-low outliers and high clusters, suggesting dynamic changes in bus trip patterns during different days of the week.
...
-   **Low Clusters:** The western parts of Singapore, mainly comprising industrial zones exhibit lower concentrations of bus trips. This pattern suggests a lower reliance on public transportation in these industrial areas which might be caused by lower population density or alternative mode of transport.

### Borders

Clusters of low passenger trips are observed along the Western and Southern borders of Singapore. Notable outliers, such as Jurong port, Pioneer Sector, and Tuas, indicate areas that serve as gateways for nearby migrant workers and tourists. These regions might have unique transportation needs, contributing to the observed patterns.
